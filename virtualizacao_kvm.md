...
Por padrão, libvirt criará uma rede privada para seus convidados na máquina host. Essa rede privada usará uma sub-rede 192.168.xx. Se precisar fornecer serviços em seus convidados que podem ser acessados por outras máquinas em sua rede host, você pode usar as regras de DNAT do iptables para encaminhar em portas específicas ou pode configurar um ambiente em ponte.
